...
curves_all <- revised_data %>% 
  ...
  # uncomment below to fit to the summarized well data
  group_by(plate, well, treatment, strains, genotype, conc) %>%
  summarise(mean_raw_length = mean(raw_length),
            mean_norm_DMSO = mean(norm_DMSO)) %>% 
  ungroup() %>%
...
predict_all <- newdata %>%
 ...
 (curve_plot_amphid <- revised_data %>%
    ...
    geom_vline(data = ec50_norm_DMSO %>% filter(curve_norm_DMSO != 'N2', route == 'Amphid'),
               aes(xintercept = estimate_norm_DMSO, group = genotype, color = route_group), linetype = 'dashed', size = 0.3) +
    geom_vline(data = ec50_norm_DMSO_all %>% filter(curve_norm_DMSO != 'N2', route == 'Amphid'),
               aes(xintercept = estimate_norm_DMSO, group = genotype), linetype = 'dashed', color = 'black', size = 0.3) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Amphid', group == 2),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#4169E1', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Amphid', group == 3),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#191970', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Amphid', group == 4),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#0096FF', size = 0.3, alpha =1) +
    ...
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                     ...
                     aes(x = conc, y = mean_norm_DMSO), color = '#4169E1', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                                                    plate != '20220210-p22-EJG_1187', route == 'Amphid', group == 3), 
                     aes(x = conc, y = mean_norm_DMSO), color = '#191970', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                                                    plate != '20220210-p22-EJG_1187', route == 'Amphid', group == 4), 
                     aes(x = conc, y = mean_norm_DMSO), color = '#0096FF', size = 0.5, width = 0.1, alpha = 1) +
    ...
    theme(
      ...
      axis.text.x = element_markdown(angle = 45, hjust = 0.5),
...
(curve_plot_cuticle <- revised_data %>%
    ...
    geom_vline(data = ec50_norm_DMSO %>% filter(curve_norm_DMSO != 'N2', route == 'Cuticle'),
               aes(xintercept = estimate_norm_DMSO, group = genotype, color = route_group), linetype = 'dashed', size = 0.3) +
    geom_vline(data = ec50s %>% filter(curve_norm_DMSO == 'N2'),
               aes(xintercept = ec50_average, group = treatment), color = 'red', linetype = 'dashed', size = 0.3) +
    ...
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Cuticle', group == 1),
             aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#94C58C', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Cuticle', group == 2),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#1A8828', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Cuticle', group == 3),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#094F26', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Cuticle', group == 4),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#2AAA8A', size = 0.3, alpha =1) +
    geom_line(data = predict_all %>% filter(route == 'Cuticle'),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = 'black', size = 0.75, alpha =1 ) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                                                    plate != '20220210-p22-EJG_1187', route == 'Cuticle', group == 1), 
                     aes(x = conc, y = mean_norm_DMSO), color = '#94C58C', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                                                    plate != '20220210-p22-EJG_1187', route == 'Cuticle', group == 2), 
                     aes(x = conc, y = mean_norm_DMSO), color = '#1A8828', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                                                    plate != '20220210-p22-EJG_1187', route == 'Cuticle', group == 3), 
                     aes(x = conc, y = mean_norm_DMSO), color = '#094F26', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
                                                    plate != '20220210-p22-EJG_1187', route == 'Cuticle', group == 4), 
                     aes(x = conc, y = mean_norm_DMSO), color = '#2AAA8A', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_hline(yintercept = 0, color = 'black', size = 0.25) +
    scale_x_log10(
      breaks = c(0.001, 0.01, 0.1, 1, 10, 100),
      labels = c(0.001, 0.01, 0.1, 1, 10, 100)) +
...
(curve_plot_digestive <- revised_data %>%
    ...
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Digestive', group == 1),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#AA98A9', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Digestive', group == 2),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#800080', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Digestive', group == 3),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#702963', size = 0.3, alpha =1) +
    geom_line(data = predict %>% filter(strains != 'N2', route == 'Digestive', group == 4),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = '#CCCCFF', size = 0.3, alpha =1) +
    geom_line(data = predict_all %>% filter(route == 'Digestive'),
              aes(x = conc, group = genotype, y = pred_norm_DMSO), color = 'black', size = 0.75, alpha =1 ) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
        plate != '20220210-p22-EJG_1187', route == 'Digestive', group == 1), 
        aes(x = conc, y = mean_norm_DMSO), color = '#AA98A9', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
        plate != '20220210-p22-EJG_1187', route == 'Digestive', group == 2), 
        aes(x = conc, y = mean_norm_DMSO), color = '#800080', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
        plate != '20220210-p22-EJG_1187', route == 'Digestive', group == 3), 
        aes(x = conc, y = mean_norm_DMSO), color = '#702963', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_quasirandom(data = well_summary %>% filter(treatment %in% c('AlbendazoleSulfoxide', 'Levamisole', 'Ivermectin'),
        plate != '20220210-p22-EJG_1187', route == 'Digestive', group == 4), 
        aes(x = conc, y = mean_norm_DMSO), color = '#CCCCFF', size = 0.5, width = 0.1, alpha = 0.6) +
    geom_hline(yintercept = 0, color = 'black', size = 0.25) +
    scale_x_log10(
      breaks = c(0.001, 0.01, 0.1, 1, 10, 100),
      labels = c(0.001, 0.01, 0.1, 1, 10, 100)) +
...
# ggsave(here('/Users/elenagarncarz/Desktop/Figure_2.pdf'), curve_plots_combined, width = 400, height = 120, units = 'mm')
# ggsave(here('/Users/elenagarncarz/Desktop/Figure_2.png'), curve_plots_combined, width = 400, height = 120, units = 'mm')
