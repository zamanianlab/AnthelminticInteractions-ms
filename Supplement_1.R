...
EC50s_combined_all <- cbind(ec50_norm_DMSO_all, ec50_sqrt_norm_DMSO_all, ec50_norm_min_all, ec50_sqrt_norm_min_all) 
...
EC50s_combined_all <- EC50s_combined_all %>% select(treatment, estimate_norm_DMSO, estimate_sqrt_norm_DMSO, estimate_norm_min, estimate_sqrt_norm_min) %>% unique()
...
plot_grid(n2_plot_sqrt_norm_DMSO,
          n2_plot_norm_min,
